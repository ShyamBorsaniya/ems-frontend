      ...
      <div className="flex items-center gap-5">
        {onToggleSidebar && (
          <button
            ...
            className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-500 hover:text-slate-700 transition-colors cursor-pointer mr-1 flex items-center justify-center border border-slate-200 bg-white shadow-xs focus:outline-none"
