...
export default function Header({
  ...
  return (
    <header className="shrink-0 z-50 flex justify-between items-center px-8 py-[0.85rem] bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-sm w-full box-border">
