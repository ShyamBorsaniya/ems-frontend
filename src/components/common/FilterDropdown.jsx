...
export default function FilterDropdown({
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block text-left">
      ...
      {/* Popover Dropdown Card / Bottom Sheet on Mobile */}
      {isOpen && (
        <>
          {/* Mobile backdrop overlay */}
          <div
            className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs z-[99] sm:hidden animate-fadeIn"
            onClick={() => setIsOpen(false)}
          />

          <div
            className={`fixed bottom-0 left-0 right-0 z-[100] w-full rounded-t-3xl bg-white border-t border-slate-200 shadow-2xl flex flex-col overflow-hidden focus:outline-none max-sm:animate-slideUp
              sm:absolute sm:bottom-auto sm:left-auto sm:right-0 sm:top-full sm:mt-2 sm:w-80 sm:rounded-2xl sm:border sm:shadow-xl sm:animate-fadeIn sm:origin-top-right`}
          >
            {/* Header */}
            ...
            {/* Body Content */}
            <div className="max-h-[60vh] sm:max-h-[480px] overflow-y-auto px-5 py-1 divide-y divide-slate-100">
            ...
            {/* Footer */}
            <div className="px-5 py-4 border-t border-slate-100 flex items-center justify-between bg-slate-50/50 gap-3 pb-6 sm:pb-4">
              <button
                type="button"
