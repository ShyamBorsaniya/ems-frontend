...
// Default mock data matching backend response format for offline fallback
const MOCK_USERS_DATA = [
  {
    id: 9,
    username: "alex_jones",
    email: "alex.jones@techcorp.com",
    first_name: "Alex",
    last_name: "Jones",
    phone: "+1-555-1007",
    profile_image: null,
    ...
    role_name: "employee",
    is_active: true,
    created_at: "2026-08-11T08:34:29.495911Z",
    updated_at: "2026-08-11T08:34:29.884798Z"
  },
  {
    id: 8,
    username: "jane_smith",
    ...
    role_name: "employee",
    is_active: true,
    created_at: "2026-08-11T08:34:29.103217Z",
    updated_at: "2026-08-11T08:34:29.484369Z"
  },
  {
    id: 7,
    username: "john_doe",
    ...
    role_name: "employee",
    is_active: true,
    created_at: "2026-08-11T08:34:28.577352Z",
    updated_at: "2026-08-11T08:34:28.969287Z"
  },
  {
    id: 6,
    username: "project_manager",
    email: "projmgr@techcorp.com",
    first_name: "Jim",
    last_name: "Halpert",
    phone: "+1-555-1004",
    profile_image: null,
    ...
    is_active: true,
    created_at: "2026-08-11T08:34:28.060106Z",
    updated_at: "2026-08-11T08:34:28.439853Z"
  },
  {
    id: 5,
    username: "dept_manager",
    email: "deptmgr@techcorp.com",
    first_name: "Michael",
    last_name: "Scott",
    phone: "+1-555-1003",
    profile_image: null,
    ...
    is_active: true,
    created_at: "2026-08-11T08:34:27.654980Z",
    updated_at: "2026-08-11T08:34:28.046346Z"
  },
  {
    id: 4,
    username: "hr_user",
    ...
    role_name: "hr",
    is_active: true,
    created_at: "2026-08-11T08:34:27.133451Z",
    updated_at: "2026-08-11T08:34:27.518702Z"
  },
  {
    id: 3,
    username: "admin",
    ...
    role_name: "admin",
    is_active: true,
    created_at: "2026-08-11T08:34:26.593023Z",
    updated_at: "2026-08-11T08:34:26.980111Z"
  },
  {
    id: 2,
    username: "SuperAdmin",
    ...
    role: null,
    is_active: true,
    created_at: "2026-08-11T08:22:55.714142Z",
    updated_at: "2026-08-11T08:22:55.714165Z"
  }
];
...
export default function UserManagement({
  ...
  // Use provided users array or fallback to MOCK_USERS_DATA
  const users = usersList && usersList.length >= 0 ? usersList : MOCK_USERS_DATA;
  ...
  // Client-side filtering as fallback or extra safety
      ...
      <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm">
        ...
        {error && (
          <div className="mb-4 p-3 rounded-xl bg-amber-50 border border-amber-200 text-amber-800 text-xs flex justify-between items-center">
            <span>⚠️ API Note: {error} (Displaying formatted user dataset)</span>
            {onRefresh && (
